    ...
    <header className="border-b-[3px] border-quizzer-black border-solid bg-quizzer-white sticky top-0 z-50 overflow-x-hidden">
      <Container className="py-4">
        <nav className="flex items-center justify-between gap-6">
          ...
          <button
            type="button"
            className="md:hidden inline-flex items-center justify-center p-2 text-2xl leading-none text-quizzer-black bg-transparent border-0 cursor-pointer hover:opacity-80"
            onClick={() => setOpen((v) => !v)}
            aria-expanded={open}
